	...
	return (
		<main className="container mx-auto h-[50vh] mt-20">
			<div className="max-w-5xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
				...
				<div className="max-w-2xl mx-auto text-center mt-36 mb-10 lg:mb-14">
					<h2 className="text-2xl font-bold md:text-4xl md:leading-tight dark:text-white">New People</h2>
